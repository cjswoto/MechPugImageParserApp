...
class ImageParserApp(tk.Tk):
    ...
    def extract_sections(self, screenshot):
        # Define the regions for team and enemy sections (you may need to adjust these values)
        team_box = (180, 140, 520, 460)  # (left, top, right, bottom)
        enemy_box = (960, 140, 1300, 460)
